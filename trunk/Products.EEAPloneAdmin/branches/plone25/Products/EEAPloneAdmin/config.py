GLOBALS = globals()
DEPENDENCIES = ['EEADesign2006', 'NavigationManager', 'PloneLanguageTool', 'LinguaPlone', 'ATVocabularyManager', 'Marshall', 'CMFonFive', 'CMFSquidTool', 'CacheSetup', 'EEAContentTypes', 'FiveSite', 'PloneGazette', 'PloneCaptcha', 'PloneHelpCenter', 'EEAEnquiry', 'RichTopic', 'ATVocabularyManager', 'XLIFFMarshall']
